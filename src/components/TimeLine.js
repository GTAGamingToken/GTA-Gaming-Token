      ...
      <div class="timeline">
        <div class="container left">
          <div class="content">
            ...
            <ul className="flex flex-col space-y-4 text-2xl">
              <li><h3>Birth Of GTA Token</h3></li>
              <li><h3>Website Development</h3></li>
              <li><h3>White Paper</h3></li>
            </ul>
          </div>
        </div>
        <div class="container right">
          <div class="content">
            ...
            <ul className="flex flex-col space-y-4 text-2xl">
              ...
              <li><h3>5,000 holders.</h3></li>
              <li><h3>Coin gecko and MarketCap listing.</h3></li>
            </ul>
          </div>
        </div>
         <div class="container left">
        ...
        <div class="container right">
          ...
          <h2>
            ...
            <ul className="flex flex-col space-y-4 text-2xl">
              <li><h3>Token Airdrop distribution.</h3></li>
              <li><h3>GTA DEX launch.</h3></li>
              <li><h3>Staking protocol launch.</h3></li>
              <li><h3>NFT airdrop distribution</h3></li>
            </ul>
          </div>
        </div>
        <div class="container left">
          <div class="content">
          <h2>
              <span>Q1 2023</span>2nd Phase CEX Listing
            </h2>
            <ul className="flex flex-col space-y-4 text-2xl">
              <li><h3>Okex</h3></li>
              <li><h3>Huboi</h3></li>
              <li><h3>Binance.</h3></li>
              <li><h3>Coinbase.</h3></li>
            </ul>
          </div>
        </div>
        <div class="container right">
